...
**NA= Not available. If NA is shown withing the column of 2021, it is not possible to calculate the mean of NA. Cannot create a variable from NA.**
...
**There are more visitors to these attrcations toward thye end of the year comparing to the start.**
